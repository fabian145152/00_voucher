...
<body>
	...
	<div class="row">
		...
		<form method="post" action="../movil_vou/exportar_tabla.php" enctype="multipart/form-data" role="form">
			<h6>Voucher de movil<input type="text" style="width : 100px " id="v_movil" name="v_movil" placeholder="MOVIL">
				<button>Buscar</button>
				<input type="reset" value="Reset buscador" class="btn btn-success btn-sm">
			</h6>
		</form>
		...
		&nbsp; &nbsp;&nbsp; &nbsp;
		<a href="vaciar_tabla_voucher.php" class="btn btn-success btn-sm">Limpiar tabla</a>
		&nbsp; &nbsp;&nbsp; &nbsp;
		<a href="#" class="btn btn-success btn-sm">SALIR</a>
	</div>
